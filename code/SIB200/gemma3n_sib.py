...
# results_folder = 'results/SIB200/sib_results_gemma3n'
# results_reply_folder = 'results/SIB200/sib_replies_gemma3n'
# results_csv_folder = 'csvs/SIB200'
# model_name =  'gemma3n'

# python code/SIB200/gemma3n_sib.py   --results_folder='results/SIB200/sib_results_gemma3n' --results_reply_folder='results/SIB200/sib_replies_gemma3n' --results_csv_folder='csvs/SIB200' --model_name='gemma-3n'
...
sib_languages = ['ace_Arab', 'ace_Latn', 'acm_Arab', 'acq_Arab', 'aeb_Arab', 'afr_Latn', 'ajp_Arab', 'aka_Latn',
...
# Save to CSV
df.to_csv("{}/{}".format(results_csv_folder, 'sib_results_{}.csv'.format(model_name)), index=False)
