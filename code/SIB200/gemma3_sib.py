...
# results_folder = '../results/SIB200/sib_results_gemma3'
# results_reply_folder = '../results/SIB200/sib_replies_gemma3'
...
# Save to CSV
df.to_csv("{}/{}.csv".format(results_csv_folder,'sib_gemma3_results_april2025.csv'), index=False)
