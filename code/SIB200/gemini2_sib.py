...
# results_folder = '../results/SIB200/sib_results_gemini2'
# results_reply_folder = '../results/SIB200/sib_replies_gemini2'
...
for language_code in languages_to_run:
    ...
    "gemma2_label": result_categories[language_code]
    })
...
# Save to a JSON file
with open("result_accuracies_prompt2_gemini2.json", "w", encoding="utf-8") as f:
...
# Save to CSV
df.to_csv("{}/{}.csv".format(results_csv_folder,'sib_gemini2_results_april2025.csv'), index=False)
