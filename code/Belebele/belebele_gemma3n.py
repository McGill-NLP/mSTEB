...
# results_folder = 'results/Belebele/belebele_predicted_gemma3n'
# results_reply_folder = 'results/Belebele/belebele_replies_gemma3n'

# python code/Belebele/belebele_gemma3n.py  --results_folder='results/Belebele/belebele_predicted_gemma3n' --results_reply_folder='results/Belebele/belebele_replies_gemma3n'
