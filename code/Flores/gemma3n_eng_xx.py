...
# python code/Flores/gemma3n_eng_xx.py   --results_translations_folder_eng_xx='results/Flores/translations_gemma3n_eng_xx'
...
for language_name in languages_to_run:
    ...
    for i in tqdm(range(1012)):  # length of devtest
        ...
        prompt = prompt_eng_xx.format(language_mapping_index[language_name], language_mapping_index[language_name],
                                      english_sentence, language_mapping_index[language_name])
