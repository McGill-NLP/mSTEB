...
# python code/Flores/gemma3n_xx_eng.py   --results_translations_folder_xx_eng='results/Flores/translations_gemma3n_xx_eng'
...
for language_name in languages_to_run:
    ...
    for i in tqdm(range(1012)):  # length of devtest
        ...
        prompt = prompt_xx_eng.format(language_mapping_index[language_name], language_mapping_index[language_name],
                                      sentence_xx)
