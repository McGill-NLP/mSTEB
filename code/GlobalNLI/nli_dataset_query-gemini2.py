...
# results_folder = '../results/GLobalNLI/nli_predicted_labels_gemini2'
# results_reply_folder = '../results/GLobalNLI/nli_replies_gemini2'
...
# Save to a JSON file
with open("result_accuracies_nli_gemini2.json", "w", encoding="utf-8") as f:
    json.dump(result_accuracies, f, ensure_ascii=False, indent=4)
    
with open("result_inaccuracies_nli_gemini2.json", "w", encoding="utf-8") as f:
...
# Save to CSV
df.to_csv("{}/{}.csv".format(results_csv_folder,'nli_results_gemini2.csv'), index=False)
...
dataset_avg_df.to_csv("{}/{}.csv".format(results_csv_folder,'nli_results_gemini2_april2025_by_family.csv'), index=False)
